...
<head>
    ...
    <link rel="stylesheet" href="quiz_aanmaken.css">
</head>
<body>
<main class="page builder-shell">
    ...
    <section class="builder-grid">
        <article class="card form-card builder-form">
            ...
            <form class="builder-form" action="quiz_opslaan.php" method="post">
                <div class="field">
                ...
                <div class="form-actions">
                    <a class="button button-ghost" href="dashboard.php">Terug</a>
